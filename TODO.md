...
- [x] **`readme.txt` placeholders.** `Contributors: wordpressdotorg` is a placeholder — set the real wp.org username(s) before submission. Optional: add Screenshots and Donate link sections (validator notes).
